...
void loop()                     // run over and over again
{
  ...
  if (millis() - timer > 2000) { 
    ...
    if (GPS.fix) {
      ...
      Serial.print("Latitude: "); Serial.print(GPS.latitude, 4); Serial.println(GPS.lat); //Gives degrees multiplied by 100 for latitude and longitude. .latitude gives the number and .lat gives direction (always north and west for our purposes)
